...
public class MemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member5 = (Button)findViewById(R.id.button7);
        member6 = (Button)findViewById(R.id.button8);
        member7 = (Button)findViewById(R.id.button9);
        member8 = (Button)findViewById(R.id.button10);
        member9 = (Button)findViewById(R.id.button11);
        member10 = (Button)findViewById(R.id.button12);
        member11 = (Button)findViewById(R.id.button13);
        member12 = (Button)findViewById(R.id.button14);
        member13 = (Button)findViewById(R.id.button15);
        member14 = (Button)findViewById(R.id.button16);
        member15 = (Button)findViewById(R.id.button17);
